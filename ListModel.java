...
public class ListModel extends AbstractTableModel {
    ...
    private String[] columnNamesCurrentRentals = {"Renter\'s " +
            "Name", "Est. Cost",
            "Rented On", "Due Date ", "Console", "Name of the Game"};

    private String[] columnNamesforRented =
            {"Renter\'s Name", "rented On Date",
                    "Due Date", "Actual date returned ",
                    "Est. Cost", " Real Cost"};
        ...
        switch (display) {
            case CurrentRentalStatus:
                ...
                for (int i = 0; i < listOfRentals.size(); i++)
                    if (listOfRentals.get(i)
                            .getActualDateReturned() == null)
            ...
            default:
                throw new RuntimeException
                        ("upDate is in undefined state: " + display);
        }
    ...
    public String getColumnName(int col) {
        ...
        throw new RuntimeException
                ("Undefined state for Col Names: " + display);
    }
    ...
    private Object currentParkScreen(int row, int col) {
        switch (col) {
            ...
            case 1:
                return (fileredListRentals.get(row).
                        getCost(fileredListRentals.
                                get(row).dueBack));

            case 2:
                return (formatter.format
                        (fileredListRentals.get(row).rentedOn.
                                getTime()));
            ...
            case 3:
                ...
                return (formatter.format
                        (fileredListRentals.get(row).dueBack.
                                getTime()));

            case 4:
                if (fileredListRentals.get(row) instanceof Console)
                    return (((Console) fileredListRentals.
                            get(row)).getConsoleType());
                else {
                    if (fileredListRentals.get(row) instanceof Game)
                        if (((Game) fileredListRentals.
                                get(row)).getConsole() != null)
                            return ((Game) fileredListRentals.
                                    get(row)).getConsole().
                                    getConsoleType();
                        else
                            return "";
    ...
    private Object rentedOutScreen(int row, int col) {
        switch (col) {
            ...
            case 1:
                return (formatter.format(fileredListRentals.
                        get(row).rentedOn.
                        getTime()));
            case 2:
                return (formatter.format(fileredListRentals.
            ...
            case 4:
                return (fileredListRentals.
                        get(row).getCost(fileredListRentals.
                                get(row).dueBack));
    ...
    public void loadDatabase(String filename) {
        ...
        try {
            ...
            listOfRentals = (MyDoubleWithOutTailLinkedList)
                    is.readObject();
            UpdateScreen();
            is.close();
        } catch (Exception ex) {
    ...
    public void createList() {
        ...
        try {
            ...
            Console console1 = new Console("Person1",
                    g4, g6, null, ConsoleTypes.PlayStation4);
            Console console2 = new Console("Person2",
                    g5, g3, null, ConsoleTypes.PlayStation4);
            Console console3 = new Console("Person5",
                    g4, g8, null, ConsoleTypes.SegaGenesisMini);
            Console console4 = new Console("Person6",
                    g4, g7, null, ConsoleTypes.SegaGenesisMini);
            Console console5 = new Console("Person1",
                    g5, g4, g3, ConsoleTypes.XBoxOneS);

            Game game1 = new Game("Person1",
                    g3, g2, null, "title1",
                    new Console("Person1",
                            g3, g2, null, ConsoleTypes.PlayStation4));
            Game game2 = new Game("Person1",
                    g3, g1, null, "title2",
                    new Console("Person1",
                            g3, g1, null, ConsoleTypes.PlayStation4));
            Game game3 = new Game("Person1",
                    g5, g3, null, "title2",
                    new Console("Person1",
                            g5, g3, null,
                            ConsoleTypes.SegaGenesisMini));
            Game game4 = new Game("Person7",
                    g4, g8, null, "title2", null);
            Game game5 = new Game("Person3",
                    g3, g1, g1, "title2",
                    new Console("Person3",
                            g3, g1, g1, ConsoleTypes.XBoxOneS));
            Game game6 = new Game("Person6",
                    g4, g7, null, "title1",
                    new Console("Person6",
                            g4, g7, null, ConsoleTypes.NintendoSwich));
            Game game7 = new Game("Person5",
                    g4, g8, null, "title1",
                    new Console("Person5",
                            g4, g8, null, ConsoleTypes.NintendoSwich));
...
//          listOfRentals.printList(); //comment this out eventually
            ...
            /*
                These commented out code is to help
                with debugging for step 2 and Step 3
            ...
            while (count < 0) {
                ...
                if (rand.nextBoolean()) {
                    ...
                    Console console = new Console
                            (guest, g4, g, null, getOneRandom(rand));
